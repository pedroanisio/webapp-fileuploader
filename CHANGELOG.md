...
- Added ProxyFix middleware to handle reverse proxy headers (X-Forwarded-Proto)
- OAuth redirect URI now correctly uses HTTPS when behind a proxy (nginx, Cloudflare, etc.)
